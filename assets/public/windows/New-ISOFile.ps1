function New-IsoFile {
    ...
    .PARAMETER Source
        Source directory. This should contain what you want on the ISO
    .PARAMETER OutFile
        Output file. This is the path to the ISO including the filename and the extension
    .PARAMETER BootFile
    ...
    .Notes
        ...
        MODIFIED: Joseph Ascanio
        LASTEDIT: 10/11/2018 14:38:01
    #>
    ...
    Param(
        ...
        [Parameter( Position = 2,
            Mandatory = $false )]
        [string]$OutFile = "$env:temp\$((Get-Date).ToString('yyyyMMdd-HHmmss.ffff')).iso",
